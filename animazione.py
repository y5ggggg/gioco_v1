...
ENEMY_PATH = "./immagini/enemy_1.png"
FRAME_W = 233
FRAME_H = 239
SHEET_COLS = 3
...
class SpriteAnimato(arcade.Sprite):
    ...
    def __init__(self, scala: float = 1.0):
        ...
        self.aggiungi_animazione("lose", SHEET_PATH, FRAME_W, FRAME_H, num_frame=1, colonne=SHEET_COLS, durata=1.0, loop=True, riga=5)
...
class Enemy(arcade.Sprite):
    ...
    def __init__(self, scala: float = 1.0):
        ...
        self.aggiungi_animazione("idle", ENEMY_PATH, 261, 226, num_frame=1, colonne=1, durata=0.6, loop=True, default=True, riga=0)
        self.aggiungi_animazione("run", ENEMY_PATH, 261, 226, num_frame=1, colonne=1, durata=0.4, loop=True, riga=1)
